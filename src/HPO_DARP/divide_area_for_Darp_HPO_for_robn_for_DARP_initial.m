function [ Area_rst ] = divide_area_for_Darp_HPO_for_robn_for_DARP_initial( Core_flag, ...
    init_grid, robot_num,parameter_of_threshold,parameter_of_iterations,parameter_of_transfer)
...
while stop==0
    ...
    fprintf('the max m value 1 = %d' , m_of_rob1);
    %fprintf(' ,  the m value of 2 = %d' , m_of_rob2);
    fprintf(' ,  the max s value = %d' , s_of_rob1);
    ...
    X3_for_printf=init_grid(3,1);
    Y3_for_printf=init_grid(3,2);
    X4_for_printf=init_grid(4,1);
    Y4_for_printf=init_grid(4,2);
    X5_for_printf=init_grid(5,1);
    Y5_for_printf=init_grid(5,2);
    X6_for_printf=init_grid(6,1);
    Y6_for_printf=init_grid(6,2);
    X7_for_printf=init_grid(7,1);
    Y7_for_printf=init_grid(7,2);
    X8_for_printf=init_grid(8,1);
    Y8_for_printf=init_grid(8,2);

    fprintf('POINT = [%d',X1_for_printf );
    fprintf(',%d]  ',Y1_for_printf );
    fprintf(' [%d',X2_for_printf );
    fprintf(',%d]',Y2_for_printf );
    fprintf(' [%d',X3_for_printf );
    fprintf(',%d]',Y3_for_printf );
    fprintf(' [%d',X4_for_printf );
    fprintf(',%d]',Y4_for_printf );
    fprintf(' [%d',X5_for_printf );
    fprintf(',%d]',Y5_for_printf );
    fprintf(' [%d',X6_for_printf );
    fprintf(',%d]',Y6_for_printf );
    fprintf(' [%d',X7_for_printf );
    fprintf(',%d]',Y7_for_printf );
    fprintf(' [%d',X8_for_printf );
    fprintf(',%d]',Y8_for_printf );
    fprintf('\n');
